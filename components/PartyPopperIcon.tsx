...
/**
 * Lucide's party-popper, drawn stroke by stroke: the confetti lines and dots
 * fly in from the popper. Plays on hover by itself, or on demand through the
 * handle (the generation readout fires it once when a deck lands). Same
 * 24-unit paths as `lucide-react`'s PartyPopper, so it keeps the icon rule.
 */
...
const LINES_VARIANTS: Variants = {
  ...
  animate: {
    ...
    translateX: [-5, 0],
    translateY: [5, 0],
    transition: { duration: 0.7, velocity: 0.3 },
  },
};
