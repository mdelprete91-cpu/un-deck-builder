...
- **Links in the brief**: paste a URL and it turns blue as you type; when you generate, the page's text is fetched and handed to the model as reference material, like an attached file (three links at most, public pages only).
