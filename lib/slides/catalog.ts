...
export const CATALOG: CatalogEntry[] = [
  ...
  { id: "callout", usage: "The signature partnership callout: What/Give/Get/KPIs/Details rows + image", fields: "title(<=8 words), blocks(3-5: label 1-2 words, body <=18 words)" },
  ...
  { id: "quote", usage: "Pull-quote from a person, green surface, use at most once", fields: "quote(<=28 words, no quotation marks), author(name or name+role)" },
  ...
  { id: "four-cards", usage: "1-4 labelled cards (4 = 2x2 grid, fewer = wider cards); What/Give/Get/KPIs or similar", fields: "title(<=8 words), blocks(1-4: label 1-2 words, body <=22 words)" },
  { id: "steps", usage: "Numbered process, 3 or 4 steps", fields: "title(<=6 words), blocks(2-4: label <=3 words, body <=20 words)" },
  ...
  { id: "icon-cards", usage: "2-4 points with icons (globe, wifi, school, chart)", fields: "title(<=6 words), blocks(2-4: label <=3 words, body <=20 words)" },
  { id: "stat-grid", usage: "Up to six KPI numbers beside a title", fields: "title(<=8 words), stats(1-6: value <=6 chars, label <=10 words)" },
  { id: "brand-equity", usage: "Intro paragraph + six supporting stats (research findings)", fields: "title(<=8 words), body(<=45 words), stats(3-6: value <=6 chars, label <=14 words)" },
  { id: "two-stats", usage: "1-2 numbers with explanations", fields: "title(<=8 words), stats(1-2: value <=6 chars, label <=25 words)" },
  ...
  { id: "chart-bars", usage: "Column chart of a simple trend or distribution", fields: "title(<=6 words), bars(2-5: label <=2 words, value = real number from the brief; chart scales to the max)" },
  ...
  { id: "timeline", usage: "Chronological milestones, 4 or 5 points", fields: "title(<=4 words), blocks(4-5: label = year or date, body <=10 words)" },
  { id: "timeline-phases", usage: "Project phases with months", fields: "title(<=4 words), blocks(2-5: label = month(s), body <=12 words)" },
  { id: "example-image-left", usage: "Two labelled paragraphs + full-height photo left", fields: "title(<=8 words), blocks(1-2: label 1-2 words, body <=40 words)" },
  { id: "example-image-right", usage: "Two labelled paragraphs + full-height photo right", fields: "title(<=8 words), blocks(1-2: label 1-2 words, body <=40 words)" },
