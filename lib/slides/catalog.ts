...
export const CATALOG: CatalogEntry[] = [
  ...
  { id: "chart-columns-grouped", usage: "Two or three measures side by side per category (2024 vs 2025)", fields: "title(<=8 words), series(2-3 names <=3 words), bars(2-10: label <=2 words, values = one real number per series)" },
  { id: "chart-columns-stacked", usage: "Composition: parts of a total per category", fields: "title(<=8 words), series(2-4 part names <=3 words), bars(2-10: label <=2 words, values = one real number per part)" },
